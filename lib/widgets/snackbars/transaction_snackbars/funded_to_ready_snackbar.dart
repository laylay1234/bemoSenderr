...
void startFundedToReadySnackbar(GlobalTransaction globalTransaction) {
  /*
  ...
  Get.snackbar(
    ...
    titleText: Text(
      'transfer.good.news'.tr,
      style: XemoTypography.bodySmallSemiBald(Get.context!)!.copyWith(color: Color(0xFF00ACE4)),
    ),
    padding: EdgeInsets.only(left: 40.w, right: 10.w, top: 20.h, bottom: 20.h),
    messageText: Text(
      'transaction.snackbar.your.transfer.to.is.ready.to.be.collected'
          .tr
