...
import '../../dialogs/transaction_details_dialog_widget.dart';

void startReadyToPaidSnackbar(GlobalTransaction globalTransaction) {
  /*
  ...
  Get.snackbar(
    ...
    messageText: Text(
      'transaction.snackbar.ready.to.paid'
          .tr
