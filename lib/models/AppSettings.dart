...
class AppSettings extends Model {
  ...
  const AppSettings._internal({required this.id, required content, createdAt, updatedAt}): _content = content, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory AppSettings({String? id, required String content}) {
  ...
  AppSettings copyWith({String? id, String? content}) {
    return AppSettings._internal(
      id: id ?? this.id,
...
class _AppSettingsModelType extends ModelType<AppSettings> {
